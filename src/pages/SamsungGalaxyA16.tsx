...
const SamsungGalaxyA16 = () => {
  ...
  const [selectedVariant, setSelectedVariant] = useState('4GB/128GB');

  const variants = [
    { name: '4GB/128GB', price: 44500 },
    { name: '6GB/128GB', price: 49500 }
  ];
  ...
  const handleAddToCart = () => {
    ...
    addToCart({
      title: `Samsung Galaxy A16 (${selectedVariant})`,
      price: selectedPrice,
      image: images[0],
      category: "Samsung"
    });
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `Galaxy A16 (${selectedVariant}) has been added to your cart`,
            ...
            <div className="space-y-6">
              <div>
                <h1 className="text-4xl lg:text-5xl font-bold mb-4">
                  <span className="text-shimmer">Samsung Galaxy A16</span>
                </h1>
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-gray-400 ml-2">(4.3/5 - 95 reviews)</span>
                </div>
              </div>
