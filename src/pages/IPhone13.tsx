...
const IPhone13 = () => {
  ...
  const variants = [
    { storage: "4GB RAM - 128GB", price: 129999 },
    { storage: "4GB RAM - 256GB", price: 139999 },
    { storage: "4GB RAM - 1TB", price: 179999 }
  ];

  const handleAddToCart = () => {
    addToCart({
      title: `iPhone 13 (${variants[selectedVariant].storage})`,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `iPhone 13 (${variants[selectedVariant].storage}) has been added to your cart`,
