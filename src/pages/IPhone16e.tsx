...
const IPhone16e = () => {
  ...
  const variants = [
    { storage: "128GB", price: 179999 },
    { storage: "256GB", price: 189999 },
    { storage: "1TB", price: 229999 }
  ];

  const keyFeatures = [
    "A17 chip with 4-core GPU",
  ...
  const handleAddToCart = () => {
    addToCart({
      title: `iPhone 16e (${variants[selectedVariant].storage})`,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `iPhone 16e (${variants[selectedVariant].storage}) has been added to your cart`,
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-gray-400 ml-2">(4.6/5 - 178 reviews)</span>
                </div>
