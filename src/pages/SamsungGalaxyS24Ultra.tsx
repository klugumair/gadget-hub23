...
const SamsungGalaxyS24Ultra = () => {
  ...
  const variants = [
    { name: '12GB/256GB', price: 404999 },
    { name: '12GB/512GB', price: 454999 },
    { name: '12GB/1TB', price: 524999 }
  ];
  ...
  const keyFeatures = [
    ...
    "Quad Camera 200MP+50MP+10MP+12MP",
    "12MP Front Camera",
    "5000mAh Battery",
    "45W Fast Charging",
    "Built-in S Pen"
  ...
  const handleAddToCart = () => {
    ...
    addToCart({
      title: `Samsung Galaxy S24 Ultra (${selectedVariant})`,
      price: selectedPrice,
      image: images[0],
      category: "Samsung"
    });
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `Samsung Galaxy S24 Ultra (${selectedVariant}) has been added to your cart`,
            ...
            <div className="space-y-6">
              <div>
                <h1 className="text-4xl lg:text-5xl font-bold mb-4">
                  <span className="text-shimmer">Samsung Galaxy S24 Ultra</span>
                </h1>
                <div className="flex items-center gap-2 mb-4">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} className="w-5 h-5 fill-gold-400 text-gold-400" />
                  ))}
                  <span className="text-gray-400 ml-2">(4.8/5 - 342 reviews)</span>
                </div>
              </div>
