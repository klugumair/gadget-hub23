...
const SamsungGalaxyS24Ultra = () => {
  ...
  const handleAddToCart = () => {
    addToCart({
      title: `Samsung Galaxy S24 Ultra (${storage})`,
      price: price,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `Samsung Galaxy S24 Ultra (${storage}) has been added to your cart`,
            ...
            <div className="space-y-6">
              ...
              <div className="glass-morphism rounded-2xl p-6">
                ...
                <ul className="space-y-2 text-gray-300">
                  <li>• Built-in S Pen with AI capabilities</li>
                  <li>• 200MP camera with AI Zoom</li>
                  <li>• 6.8" Dynamic AMOLED 2X display</li>
                  <li>• Snapdragon 8 Gen 3 for Galaxy</li>
                  <li>• Titanium frame with Gorilla Glass</li>
                </ul>
              </div>
