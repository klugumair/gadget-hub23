...
const IPhone15Plus = () => {
  ...
  const variants = [
    { storage: "6GB RAM - 128GB", price: 179999 },
    { storage: "6GB RAM - 256GB", price: 189999 },
    { storage: "6GB RAM - 1TB", price: 229999 }
  ];

  const handleAddToCart = () => {
    addToCart({
      title: `iPhone 15 Plus (${variants[selectedVariant].storage})`,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `iPhone 15 Plus (${variants[selectedVariant].storage}) has been added to your cart`,
            ...
            <div className="space-y-6">
              ...
              <div className="glass-morphism rounded-2xl p-6">
                ...
                <ul className="space-y-2 text-gray-300">
                  ...
                  <li>• Advanced dual-camera system with 48MP Main and Ultra Wide cameras</li>
