...
const IPhone14 = () => {
  ...
  const variants = [
    { storage: "6GB RAM - 128GB", price: 149999 },
    { storage: "6GB RAM - 256GB", price: 159999 },
    { storage: "6GB RAM - 1TB", price: 199999 }
  ];

  const handleAddToCart = () => {
    addToCart({
      title: `iPhone 14 (${variants[selectedVariant].storage})`,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `iPhone 14 (${variants[selectedVariant].storage}) has been added to your cart`,
