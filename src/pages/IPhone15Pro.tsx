...
const IPhone15Pro = () => {
  ...
  const variants = [
    { storage: "8GB RAM - 128GB", price: 199999 },
    { storage: "8GB RAM - 256GB", price: 209999 },
    { storage: "8GB RAM - 1TB", price: 249999 }
  ];

  const handleAddToCart = () => {
    addToCart({
      title: `iPhone 15 Pro (${variants[selectedVariant].storage})`,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `iPhone 15 Pro (${variants[selectedVariant].storage}) has been added to your cart`,
            ...
            <div className="space-y-6">
              ...
              <div className="glass-morphism rounded-2xl p-6">
                ...
                <ul className="space-y-2 text-gray-300">
                  ...
                  <li>• Pro camera system with 48MP Main, Ultra Wide, and Telephoto</li>
