...
const IPhone12 = () => {
  ...
  const variants = [
    { storage: "4GB RAM - 64GB", price: 109999 },
    { storage: "4GB RAM - 128GB", price: 114999 },
    { storage: "4GB RAM - 256GB", price: 124999 }
  ];

  const handleAddToCart = () => {
    addToCart({
      title: `iPhone 12 (${variants[selectedVariant].storage})`,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `iPhone 12 (${variants[selectedVariant].storage}) has been added to your cart`,
