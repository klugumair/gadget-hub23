...
const IPhone13ProMax = () => {
  ...
  const variants = [
    { storage: "4GB RAM - 128GB", price: 169999 },
    { storage: "4GB RAM - 256GB", price: 179999 },
    { storage: "4GB RAM - 1TB", price: 219999 }
  ];

  const handleAddToCart = () => {
    addToCart({
      title: `iPhone 13 Pro Max (${variants[selectedVariant].storage})`,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `iPhone 13 Pro Max (${variants[selectedVariant].storage}) has been added to your cart`,
