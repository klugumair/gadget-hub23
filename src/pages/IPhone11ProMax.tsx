...
const IPhone11ProMax = () => {
  ...
  const variants = [
    { storage: "4GB RAM - 64GB", price: 129999 },
    { storage: "4GB RAM - 128GB", price: 134999 },
    { storage: "4GB RAM - 256GB", price: 144999 }
  ];
  ...
  const handleAddToCart = () => {
    addToCart({
      title: `iPhone 11 Pro Max (${variants[selectedVariant].storage})`,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `iPhone 11 Pro Max (${variants[selectedVariant].storage}) has been added to your cart`,
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-gray-400 ml-2">(4.5/5 - 412 reviews)</span>
                </div>
