...
const IPhone12Pro = () => {
  ...
  const variants = [
    { storage: "4GB RAM - 64GB", price: 139999 },
    { storage: "4GB RAM - 128GB", price: 144999 },
    { storage: "4GB RAM - 256GB", price: 154999 }
  ];

  const handleAddToCart = () => {
    addToCart({
      title: `iPhone 12 Pro (${variants[selectedVariant].storage})`,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `iPhone 12 Pro (${variants[selectedVariant].storage}) has been added to your cart`,
