...
const RoninR920Pro = () => {
  ...
  const variants = [
    { color: "Matte Black", price: 3500 },
    { color: "Gun Metal", price: 3500 },
    { color: "Carbon Black", price: 3500 }
  ];
  ...
  const keyFeatures = [
    ...
    "Detachable cable with gold-plated connectors",
  ...
  const handleAddToCart = () => {
    addToCart({
      title: `Ronin R-920 Pro (${variants[selectedVariant].color})`,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `Ronin R-920 Pro (${variants[selectedVariant].color}) has been added to your cart`,
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-gray-400 ml-2">(4.3/5 - 184 reviews)</span>
                </div>
