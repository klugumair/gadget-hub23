...
const IPhone12Mini = () => {
  ...
  const variants = [
    { storage: "4GB RAM - 64GB", price: 99999 },
    { storage: "4GB RAM - 128GB", price: 104999 },
    { storage: "4GB RAM - 256GB", price: 114999 }
  ];

  const handleAddToCart = () => {
    addToCart({
      title: `iPhone 12 Mini (${variants[selectedVariant].storage})`,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `iPhone 12 Mini (${variants[selectedVariant].storage}) has been added to your cart`,
            ...
            <div className="space-y-6">
              ...
              <div className="glass-morphism rounded-2xl p-6">
                ...
                <ul className="space-y-2 text-gray-300">
                  ...
                  <li>• Dual-camera system with 12MP Ultra Wide and Wide cameras</li>
