...
const CrystalClearArmor = () => {
  ...
  const variants = [
    { compatibility: "iPhone 15 Series", price: 3000 },
    { compatibility: "iPhone 14 Series", price: 3000 },
    { compatibility: "Samsung Galaxy S24 Series", price: 3000 }
  ];
  ...
  const keyFeatures = [
    ...
    "Lifetime clarity guarantee"
  ];

  const handleAddToCart = () => {
    addToCart({
      title: `Crystal Clear Armor (${variants[selectedVariant].compatibility})`,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `Crystal Clear Armor (${variants[selectedVariant].compatibility}) has been added to your cart`,
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-gray-400 ml-2">(4.5/5 - 672 reviews)</span>
                </div>
...
export default CrystalClearArmor;
