...
const SamsungGalaxyS23FE = () => {
  const [selectedVariant, setSelectedVariant] = useState('8GB/128GB');
  const { addToCart } = useCart();
  const { toast } = useToast();

  const variants = [
    { name: '8GB/128GB', price: 168299 },
    { name: '8GB/256GB', price: 188299 }
  ];
  ...
  const handleAddToCart = () => {
    ...
    addToCart({
      title: `Samsung Galaxy S23 FE (${selectedVariant})`,
      price: selectedPrice,
      image: images[0],
      category: "Samsung"
    });
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `Samsung Galaxy S23 FE (${selectedVariant}) has been added to your cart`,
            ...
            <div className="space-y-6">
              <div>
                <h1 className="text-4xl lg:text-5xl font-bold mb-4">
                  <span className="text-shimmer">Samsung Galaxy S23 FE</span>
                </h1>
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-gray-400 ml-2">(4.5/5 - 156 reviews)</span>
                </div>
              </div>
...
export default SamsungGalaxyS23FE;
