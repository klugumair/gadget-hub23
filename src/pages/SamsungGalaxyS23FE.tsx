...
const SamsungGalaxyS23FE = () => {
  ...
  const handleAddToCart = () => {
    addToCart({
      title: `Samsung Galaxy S23 FE (${storage})`,
      price: price,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `Samsung Galaxy S23 FE (${storage}) has been added to your cart`,
            ...
            <div className="space-y-6">
              ...
              <div className="glass-morphism rounded-2xl p-6">
                ...
                <ul className="space-y-2 text-gray-300">
                  <li>• Latest Snapdragon processor</li>
                  <li>• Advanced triple camera system</li>
                  <li>• 120Hz Dynamic AMOLED 2X display</li>
                  <li>• Enhanced night photography</li>
                  <li>• Wireless charging & PowerShare</li>
                </ul>
              </div>
