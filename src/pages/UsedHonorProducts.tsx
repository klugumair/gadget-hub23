        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <h1 className="text-6xl lg:text-7xl font-bold mb-6 leading-tight">
              <span className="text-shimmer">Used Honor Collection</span>
            </h1>
            <p className="text-2xl text-gray-300 mb-12">
              Quality pre-owned Honor devices at great prices
            </p>
            
            <div className="mb-16">
              <div className="glass-morphism rounded-2xl p-8 max-w-2xl mx-auto">
                <h2 className="text-4xl font-bold text-white mb-4">
                  <span className="text-shimmer">Sell Your Used Honor Phone</span>
                </h2>
                <p className="text-xl text-gray-300 mb-6">
                  Get the best value for your Honor device. Upload details and images, and our team will review your submission.
                </p>
                <Link to="/sell-honor-phone">
          ...
          <div className="mb-16">
            <h2 className="text-4xl font-bold text-center text-white mb-8">
              <span className="text-shimmer">Available Used Honor Phones</span>
            </h2>
              ...
              <div className="text-center">
                <div className="glass-morphism rounded-2xl p-12 max-w-md mx-auto">
                  ...
                  <h3 className="text-3xl font-bold text-white mb-4">
                    No Used Honor Phones Available
                  </h3>
                  <p className="text-xl text-gray-400">
                    We're working hard to bring you quality used Honor devices. Check back soon or sell your phone to us!
                  </p>
                </div>
              </div>
            )}
...
export default UsedHonorProducts;
