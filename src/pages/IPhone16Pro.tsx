...
const IPhone16Pro = () => {
  ...
  const variants = [
    { storage: "128GB", price: 219999 },
    { storage: "256GB", price: 229999 },
    { storage: "1TB", price: 269999 }
  ];

  const handleAddToCart = () => {
    addToCart({
      title: `iPhone 16 Pro (${variants[selectedVariant].storage})`,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `iPhone 16 Pro (${variants[selectedVariant].storage}) has been added to your cart`,
            ...
            <div className="space-y-6">
              ...
              <div className="glass-morphism rounded-2xl p-6">
                ...
                <ul className="space-y-2 text-gray-300">
                  ...
                  <li>• 6.3-inch Super Retina XDR display with ProMotion</li>
