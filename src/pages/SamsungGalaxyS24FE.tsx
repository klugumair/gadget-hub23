...
const SamsungGalaxyS24FE = () => {
  ...
  const handleAddToCart = () => {
    addToCart({
      title: `Samsung Galaxy S24 FE (${storage})`,
      price: price,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `Samsung Galaxy S24 FE (${storage}) has been added to your cart`,
            ...
            <div className="space-y-6">
              ...
              <div className="glass-morphism rounded-2xl p-6">
                ...
                <ul className="space-y-2 text-gray-300">
                  <li>• Latest Exynos 2400e processor</li>
                  <li>• AI-enhanced photography</li>
                  <li>• 6.7" Dynamic AMOLED 2X display</li>
                  <li>• Galaxy AI features</li>
                  <li>• 4700mAh battery with 25W charging</li>
                </ul>
              </div>
