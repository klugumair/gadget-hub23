...
const IPhone16Plus = () => {
  ...
  const variants = [
    { storage: "128GB", price: 199999 },
    { storage: "256GB", price: 209999 },
    { storage: "1TB", price: 249999 }
  ];

  const keyFeatures = [
    "A18 chip with 5-core GPU",
    "6.7-inch Super Retina XDR display",
    "Advanced dual-camera system with 48MP Fusion camera",
    "Face ID for secure authentication",
    "USB-C connectivity",
    "Extended battery life",
    "iOS 18 with enhanced features"
  ];

  const handleAddToCart = () => {
    addToCart({
      title: `iPhone 16 Plus (${variants[selectedVariant].storage})`,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `iPhone 16 Plus (${variants[selectedVariant].storage}) has been added to your cart`,
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-gray-400 ml-2">(4.7/5 - 192 reviews)</span>
                </div>
