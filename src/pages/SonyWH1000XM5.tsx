...
const SonyWH1000XM5 = () => {
  ...
  const variants = [
    { color: "Black", price: 116999 },
    { color: "Silver", price: 116999 },
    { color: "Midnight Blue", price: 116999 }
  ];
  ...
  const keyFeatures = [
    ...
    "Premium comfort with soft fit leather",
    "DSEE Extreme upscales compressed audio files",
  ...
  const handleAddToCart = () => {
    addToCart({
      title: `Sony WH-1000XM5 (${variants[selectedVariant].color})`,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `Sony WH-1000XM5 (${variants[selectedVariant].color}) has been added to your cart`,
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-gray-400 ml-2">(4.6/5 - 892 reviews)</span>
                </div>
