...
const LuxuryLeatherCase = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  const [selectedVariant, setSelectedVariant] = useState(0);
  const { addToCart } = useCart();
  const { toast } = useToast();

  const productImages = ["🛡️", "🛡️", "🛡️", "🛡️"];

  const variants = [
    { compatibility: "iPhone 15 Series", price: 1500 },
    { compatibility: "iPhone 14 Series", price: 1500 },
    { compatibility: "Samsung Galaxy S24 Series", price: 1500 }
  ];

  const keyFeatures = [
    "Genuine Italian leather construction",
    "Precision-cut for perfect fit",
    "Magnetic closure with card slots",
    "Scratch-resistant interior lining",
    "Wireless charging compatible",
    "Drop protection up to 6 feet",
    "Premium stitching and craftsmanship",
    "Available in multiple color options"
  ];

  const handleAddToCart = () => {
    addToCart({
      title: `Luxury Leather Case (${variants[selectedVariant].compatibility})`,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `Luxury Leather Case (${variants[selectedVariant].compatibility}) has been added to your cart`,
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-gray-400 ml-2">(4.8/5 - 432 reviews)</span>
                </div>
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-bold text-white">Choose Compatibility</h3>
                  ...
                  {variants.map((variant, index) => (
                    ...
                    >
                      <div className="flex justify-between items-center">
                        <div className="text-white font-semibold">{variant.compatibility}</div>
...
export default LuxuryLeatherCase;
