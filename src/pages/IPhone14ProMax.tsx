...
const IPhone14ProMax = () => {
  ...
  const variants = [
    { storage: "6GB RAM - 128GB", price: 189999 },
    { storage: "6GB RAM - 256GB", price: 199999 },
    { storage: "6GB RAM - 1TB", price: 239999 }
  ];

  const handleAddToCart = () => {
    addToCart({
      title: `iPhone 14 Pro Max (${variants[selectedVariant].storage})`,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `iPhone 14 Pro Max (${variants[selectedVariant].storage}) has been added to your cart`,
