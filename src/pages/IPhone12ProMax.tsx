...
const IPhone12ProMax = () => {
  ...
  const variants = [
    { storage: "4GB RAM - 64GB", price: 149999 },
    { storage: "4GB RAM - 128GB", price: 154999 },
    { storage: "4GB RAM - 256GB", price: 164999 }
  ];

  const handleAddToCart = () => {
    addToCart({
      title: `iPhone 12 Pro Max (${variants[selectedVariant].storage})`,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `iPhone 12 Pro Max (${variants[selectedVariant].storage}) has been added to your cart`,
            ...
            <div className="space-y-6">
              ...
              <div className="glass-morphism rounded-2xl p-6">
                ...
                <ul className="space-y-2 text-gray-300">
                  <li>• A14 Bionic chip with Next-generation Neural Engine</li>
                  <li>• 6.7-inch Super Retina XDR display</li>
                  <li>• Pro camera system with 12MP Ultra Wide, Wide, and Telephoto cameras</li>
