...
const IPhone16ProMax = () => {
  ...
  const variants = [
    { storage: "128GB", price: 229999 },
    { storage: "256GB", price: 239999 },
    { storage: "1TB", price: 279999 }
  ];

  const keyFeatures = [
    "A18 Pro chip with 6-core GPU",
    "6.9-inch Super Retina XDR display with ProMotion",
    "Pro camera system with 48MP Fusion, Ultra Wide, and Telephoto",
    "Face ID for secure authentication",
    "USB-C connectivity with Thunderbolt",
    "Longest battery life ever in iPhone",
    "Advanced ProRAW and ProRes recording"
  ];

  const handleAddToCart = () => {
    addToCart({
      title: `iPhone 16 Pro Max (${variants[selectedVariant].storage})`,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `iPhone 16 Pro Max (${variants[selectedVariant].storage}) has been added to your cart`,
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-gray-400 ml-2">(4.9/5 - 98 reviews)</span>
                </div>
