...
const IPhone15 = () => {
  ...
  const variants = [
    { storage: "8GB RAM - 128GB", price: 169999 },
    { storage: "8GB RAM - 256GB", price: 179999 },
    { storage: "8GB RAM - 1TB", price: 219999 }
  ];

  const handleAddToCart = () => {
    addToCart({
      title: `iPhone 15 (${variants[selectedVariant].storage})`,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `iPhone 15 (${variants[selectedVariant].storage}) has been added to your cart`,
