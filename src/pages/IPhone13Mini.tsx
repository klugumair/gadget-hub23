...
const IPhone13Mini = () => {
  ...
  const variants = [
    { storage: "4GB RAM - 128GB", price: 119999 },
    { storage: "4GB RAM - 256GB", price: 129999 },
    { storage: "4GB RAM - 1TB", price: 169999 }
  ];

  const handleAddToCart = () => {
    addToCart({
      title: `iPhone 13 Mini (${variants[selectedVariant].storage})`,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `iPhone 13 Mini (${variants[selectedVariant].storage}) has been added to your cart`,
