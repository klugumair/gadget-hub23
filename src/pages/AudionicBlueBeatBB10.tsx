...
const AudionicBlueBeatBB10 = () => {
  ...
  const variants = [
    { color: "Electric Blue", price: 4500 },
    { color: "Midnight Black", price: 4500 },
    { color: "Royal Red", price: 4500 }
  ];

  const keyFeatures = [
    "Bluetooth 5.0 wireless connectivity",
    "Active noise cancellation technology",
    "20-hour battery life with quick charge",
    "Deep bass enhancement system",
  ...
  const handleAddToCart = () => {
    addToCart({
      title: `Audionic Blue Beat BB-10 (${variants[selectedVariant].color})`,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `Audionic Blue Beat BB-10 (${variants[selectedVariant].color}) has been added to your cart`,
    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="py-32">
        <div className="container mx-auto px-6">
          <div className="mb-8">
            <Link to="/headphones" className="inline-block">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-gray-400 ml-2">(4.2/5 - 156 reviews)</span>
                </div>
...
export default AudionicBlueBeatBB10;
