...
const IPhone16 = () => {
  ...
  const variants = [
    { storage: "128GB", price: 189999 },
    { storage: "256GB", price: 199999 },
    { storage: "1TB", price: 239999 }
  ];
  ...
  const handleAddToCart = () => {
    addToCart({
      title: `iPhone 16 (${variants[selectedVariant].storage})`,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `iPhone 16 (${variants[selectedVariant].storage}) has been added to your cart`,
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-gray-400 ml-2">(4.8/5 - 256 reviews)</span>
                </div>
