...
const IPhone13Pro = () => {
  ...
  const variants = [
    { storage: "4GB RAM - 128GB", price: 159999 },
    { storage: "4GB RAM - 256GB", price: 169999 },
    { storage: "4GB RAM - 1TB", price: 209999 }
  ];

  const handleAddToCart = () => {
    addToCart({
      title: `iPhone 13 Pro (${variants[selectedVariant].storage})`,
    ...
    toast({
      title: "Added to Cart! 🛒",
      description: `iPhone 13 Pro (${variants[selectedVariant].storage}) has been added to your cart`,
